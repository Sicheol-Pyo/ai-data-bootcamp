...
### 최종적으로 일본 여행에 있어 식당 선택 시 타베로그를 사용하여 검색하는 것이 구글이나 블로그에서 찾는 것 보다 더 효율적일까?  
...
4. 상위 10% 제외한 메뉴들 중 각 도시별로 특이하게 나타나는 메뉴가 있는지 비교 필요
5. 현재 '예약이 많은 순'으로 분석하였으나 '현지인 예약이 많은 순'과 비교하여 양상이 비슷한지 비교 필요.
6. 각 도시별로 menu를 상세 정보를 취합하여 구체적인 식당 예매 정보를 비교 필요
